...
import React,{ useEffect,useCallback,useState,useRef }  from 'react';
    ...
    return (
      ...
      <Table variant='simple'>
        <Thead>
          <Tr>
            <Th><Button id= "button" colorScheme= 'teal' variant= 'outline' onClick={onRegisterOpen}>登録</Button></Th>
            <Th>企業名</Th>
            <Th>企業番号</Th>
            <Th>最終結果</Th>
            <Th>内定承諾提出日</Th>
        ...
        <Tbody>
          <Tr>
            ...
            <Td>M/D</Td>
            <Td>NULL</Td>
            <Td><Button colorScheme= 'teal' variant= 'outline' onClick={onWorkOpen} >活動内容</Button></Td>
            <Td><Button colorScheme= 'teal' variant= 'outline' onClick={onChangeOpen}>変更</Button></Td>
          </Tr>
          <Tr>
            <Td></Td>
            <Td>株式会社B</Td>
    ...
    <ModalContent>
      ...
      <Button colorScheme='blue' mr={3}>
        ...
        <Button onClick={onRegisterClose}>
          閉じる
        </Button>
      </ModalFooter>
    </ModalContent>
